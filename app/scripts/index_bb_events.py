...
solr_url = 'http://localhost:8983/solr/acme_events/update'
commit_url = 'http://localhost:8983/solr/acme_events/update?commit=true'
delete_url = 'http://localhost:8983/solr/acme_events/update?stream.body=<delete><query>*:*</query></delete>'
