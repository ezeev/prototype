...
solr_url = 'http://localhost:8983/solr/acme_items/update'
commit_url = 'http://localhost:8983/solr/acme_items/update?commit=true'
delete_url = 'http://localhost:8983/solr/acme_items/update?stream.body=<delete><query>*:*</query></delete>'
